...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant helps the company employees with content creation.
...
"""
    query_prompt_few_shots = [
        {"role": USER, "content": "Provide me an analysis of the code?"},
        {"role": ASSISTANT, "content": "Here is the analsis of the code as per guidelines 1. Analysis 2. Modified Code 3. References "},
        {"role": USER, "content": "Is there any other recommendation"},
        {"role": ASSISTANT, "content": "Yes here are some additional recommendations as per the guidelines"},
    ]
    ...
    async def run_until_final_call(
        ...
        chat_completion = await openai.ChatCompletion.acreate(
            **chatgpt_args,
            ...
            messages=messages,
            temperature=0,
            max_tokens=2000,  # Setting too low risks malformed JSON, setting too high may affect performance
            n=1,
            functions=functions,
            function_call="auto",
        )
